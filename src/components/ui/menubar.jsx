...
const Menubar = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex md:h-20  h-full  mt-0 md:mt-6 items-center space-x-1 rounded-md border w-60 border-slate-300 md:bg-white bg-yellow-100  p-1 dark:border-slate-800 dark:bg-slate-950 md:w-fit back   mx-auto shadow-sm shadow-black  relative z-50",
      className
    )}
    {...props}
  />
...
const MenubarTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex hover:text-blue-400 cursor-default select-none items-center rounded-sm px-3 py-1.5 text-sm font-medium outline-none md:bg-white bg-yellow-100 sm:flex sm:flex-col focus:text-slate-900 data-[state=open]:bg-white data-[state=open]:text-slate-900 dark:focus:bg-slate-800 dark:focus:text-slate-50 dark:data-[state=open]:bg-white  dark:data-[state=open]:text-slate-50 ml-80",
      className
    )}
    {...props}
  />
